      ...
      if (data.user) {
        ...
        if (roleData?.role !== 'hr') {
          ...
          toast({
            variant: "destructive",
            title: "Access denied",
            description: "This account is not registered as an HR account. Please use the job seeker login.",
          });
          return;
        }
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.user) {
        ...
        toast({
          title: "Success!",
          description: "HR account created successfully. You are now logged in.",
        });
        navigate("/dashboard");
      }
    } catch (error) {
